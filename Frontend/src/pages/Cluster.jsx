...
const Cluster = () => {
  ...
  useEffect(() => {
    const startConversation = async () => {
      ...
      try {
        ...
        const healthCheck = await fetch('https://burp.contactsushil.me/api/agents/status');
      ...
      try {
        ...
        const response = await fetch('https://burp.contactsushil.me/api/agents/chat/public', {
          method: 'POST',
          headers: {
  ...
  const sendToAI = async (userMessage) => {
    ...
    try {
      ...
      let apiUrl = 'https://burp.contactsushil.me/api/agents/chat';
      let headers = {
        'Content-Type': 'application/json'
      };
      ...
      if (authToken) {
        ...
        apiUrl = 'https://burp.contactsushil.me/api/agents/chat/public';
  ...
  const saveClusterToDatabase = async (clusterData) => {
    ...
    try {
      ...
      const response = await fetch('https://burp.contactsushil.me/api/baskets/ai-create', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
